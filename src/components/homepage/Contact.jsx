...
const Contact = () => {
  return (
    <section  className="relative  py-16 md:py-24 bg-[#fafafa] font-sans ">
      ...
      <img src='/home-contact/img4.png' className="absolute bottom-[-10%] right-[40%] w-32 h-32 text-[#0051FF]" fill="none" />
      <img src='/home-contact/img2.png' className="absolute top-[40%] right-12 w-40 h-40 h-24 text-[#0051FF]" fill="none" />
